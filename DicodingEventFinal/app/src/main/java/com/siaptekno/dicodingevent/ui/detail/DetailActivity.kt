...
import com.siaptekno.dicodingevent.databinding.ActivityDetailBinding
...
class DetailActivity : AppCompatActivity() {
    ...
    private fun updateFavButton() {
        binding.fabFavorite.setImageResource(if (isFavorite) R.drawable.ic_favorite__filled_24 else R.drawable.ic_favorite_outlined_24)
    }
